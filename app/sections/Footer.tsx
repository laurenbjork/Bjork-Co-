...
import { footerSections } from '@/app/data/navigation';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          {footerSections.map((section) => (
            <div key={section.title}>
              <h3 className="text-[11px] font-medium tracking-[0.1em] uppercase mb-4 text-white/80">
                {section.title}
              </h3>
